...
<body>
					...
					<c:choose>
						<c:when test="${ empty loginUser }">
							...
							<li><a href="memberUpdate.do?userid=${loginUser.userid }"
								target="_self" onclick="return false">마이페이지▽</a></li>
						</c:when>
						<c:otherwise>
							...
							<li><a href="memberUpdate.do?userid=${loginUser.userid }"
								target="_self" onclick="return true">마이페이지▽</a></li>
						</c:otherwise>
					</c:choose>
	...
	<div id="boardList">
		<div id="boardList" align="center">
			<h1 style="font-size: 30px; line-height: 40px; font-weight: 600;">게시글 상세보기</h1>
	...
	<div style="width: 960px; height: 100px; margin: 10px auto;">
		<div style="padding-top: 10px;">
			<img alt="loginFooterAD" src="img/member/bn_login_n_960x60.gif"

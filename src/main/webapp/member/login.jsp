...
<body>
								...
								<li class="fast-search-div-li"><a href="sub.jsp"
									...
									<div class="fast-search-div">
										<div class="fast-search-content">
											...
											<div class="fast-search-banner">
												<a href="sub.jsp" target="_self"><img alt="직배송 중고책 슈퍼특가"
													src="img/qUsed_0126.png"></a>
											</div>
										</div>
									</div></li>
								<li class="fast-search-div-li"><a href="sub.jsp"
	...
	<div id="loginDiv">
		<div class="loginDiv">
			<div class="loginLeft">
				<form action="login.do" method="POST" name="frm" class="loginForm">
					<input type="text" autocomplete="off" name="userid" placeholder="아이디" class="loginInput">
					<br><br>
					<input type="password" name="pwd" placeholder="비밀번호" class="loginInput">
					<br><br><br>
					<input type="submit" value="로그인" class="loginSubmit" onclick="loginCheck()">
					<input type="button" value="회원가입" class="loginJoin" onclick="location.href='join.do'">
				</form>
			</div>
			<div class="loginRight">
				<div style="width: 360px; height: 360px; margin-bottom: 10px;">
					<img alt="loginAD" src="img/member/march_goods.jpg" style="width: 100%; height: 100%;">
				</div>
				<div style="width: 360px; height: 140px;">
					<img alt="loginAD" src="img/member/login_48485.jpg" style="width: 100; height: 100%;">
				</div>
			</div>
		</div>	
	</div>
